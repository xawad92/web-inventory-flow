...
const TITLE = "টর্ক Moto — বাংলাদেশের প্রিমিয়াম নতুন ও ব্যবহৃত মোটরসাইকেল শোরুম";
const DESCRIPTION =
  "সেরা মূল্যে প্রিমিয়াম নতুন ও ব্যবহৃত মোটরসাইকেল কিনুন, বিক্রি করুন অথবা এক্সচেঞ্জ করুন। লাইভ স্টক, ৪০+ যাচাইকৃত রিভিউ এবং ১০০% সুপারিশ।";
...
const FEATURES = [
  {
    num: "01 — কিনুন",
    title: "প্রিমিয়াম নতুন ও ব্যবহৃত বাইক কিনুন",
    body: "যাচাইকৃত ইঞ্জিন ও কাগজপত্রসহ সেরা কন্ডিশনের নতুন ও ইউজড বাইক, বেস্ট প্রাইজে।",
    mark: "B",
    reverse: false,
  },
  {
      ...
      <main>
        <header className="tm-hero" id="top">
          ...
          <div className="hero-inner">
            <div className="hero-eyebrow bn">বাংলাদেশের সেরা প্রিমিয়াম নতুন ও ইউজড বাইকের শোরুম</div>
            <h1>
              আজই আপনার
              <br />
              <em>নতুন বাইকটি</em> নিয়ে বাড়ি ফিরুন।
            </h1>
            <p className="hero-sub bn">
              আপনার পছন্দের প্রিমিয়াম নতুন ও ইউজড বাইকটি বেস্ট প্রাইজে কিনুন, বিক্রি করুন অথবা
              এক্সচেঞ্জ করতে আজই চলে আসুন টর্ক মোটো-তে।
            </p>
        ...
        <div className="tm-wrap">
          <div className="foot-grid">
            <div>
              ...
              <p className="bn">
                বাংলাদেশের সেরা প্রিমিয়াম নতুন ও ইউজড বাইকের শোরুম। বিশ্বস্ততার সাথে কেনা, বিক্রি
                ও এক্সচেঞ্জ সেবা দিয়ে আসছি।
              </p>
          ...
          <div className="foot-bottom">
            ...
            <span className="bn">বাংলাদেশের সেরা প্রিমিয়াম নতুন ও ইউজড বাইকের শোরুম</span>
          </div>
        </div>
      </footer>
      <BackToTop />
